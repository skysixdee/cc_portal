...
//     if (controller.subscriptionList[index].offerStatus == "A") {
//       await deleteToneApi(controller.subscriptionList[index].offerStatus);
//     } else {
//       await BuyToneApi(controller.subscriptionList[index].offerStatus);
//     }

   
//     controller.subscriptionList[index].offerStatus =
//         (controller.subscriptionList[index].offerStatus == "A") ? "S" : "A";
//     controller.subscriptionList.refresh();
//   } finally {
